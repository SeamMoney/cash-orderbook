 ...
 * On mobile (<768px): hamburger menu that expands to show tabs + wallet connect.
 */
export function Nav({
  activeTab = "trade",
  onTabChange,
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/90 backdrop-blur-md">
      <div className="mx-auto flex h-14 max-w-[1400px] items-center justify-between px-4 sm:px-6">
        ...
        {/* Right: Search + Connect (desktop) + Hamburger (mobile) */}
        <div className="flex items-center gap-3">
          ...
          {/* Connect Wallet — hidden on mobile, shown in mobile menu instead */}
